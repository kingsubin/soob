...
public class AccountController {
    ...
    public ResultResponse<Void> signupAccount(
            @ApiParam(name = "회원가입DTO", required = true) @Valid @RequestBody final AccountSignupRequestDto signupRequestDto) {
    ...
    public ResultResponse<Void> login(
            @ApiParam(name = "로그인DTO", required = true) @Valid @RequestBody final AccountLoginRequestDto loginRequestDto,
    ...
    public ResultResponse<AccountResponseDto> retrieveAccount(
            @ApiParam(name = "회원번호", required = true) @PathVariable Long accountId) {
    ...
    public ResultResponse<AccountResponseDto> updateAccount(
            @ApiParam(name = "회원번호", required = true) @PathVariable Long accountId,
            @ApiParam(name = "닉네임DTO")  @Valid @RequestBody final AccountUpdateRequestDto updateRequestDto,
            @ApiParam(name = "프로필이미지") @RequestParam("profileImage") MultipartFile file) {
    ...
    public ResultResponse<Boolean> checkNicknameDuplicated(
            @ApiParam(name = "NICKNAME", required = true) @PathVariable String nickname) {
    ...
    public ResultResponse<Void> verifyEmail(
            @ApiParam(name = "KEY", required = true) @PathVariable String key) {
